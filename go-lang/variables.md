...
En golang toda variable propuesta se debe utilizar, sino va a dar error, una forma de prevenir el error si no se va a utilizar es colocar antes el \_ por ejemplo:

```
var i int = 10
_i //esta forma no da error no utilizar la variable
```
...
sum := 8 + 3.5
var sum int = 8 + 3.5
// notese que para crear una variable sin decirle que es variable y su tipo se 
// debe utilizar la sintaxis :=
```

Dejamos un ejemplo que nos facilitan en el curso de Udemy
